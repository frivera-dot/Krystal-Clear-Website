...
export const cities: City[] = [
  ...
  },
  {
    ...
    nearby: ["el-cerrito", "pinole", "hercules", "berkeley", "san-pablo"],
    lat: 37.9358,
    lng: -122.3477,
  },
  {
  ...
  },
  {
    ...
    nearby: ["hercules", "richmond", "el-cerrito", "vallejo", "san-pablo"],
    lat: 38.0044,
    lng: -122.2989,
  },
  ...
  },
  {
    ...
    nearby: ["fairfield", "suisun-city", "davis", "dixon"],
    lat: 38.3566,
    lng: -121.9877,
  },
  {
  ...
  },
  {
    ...
    zip: "94806",
    intro:
      "San Pablo packs real commercial activity into one of West County's most compact footprints. San Pablo Lytton Casino anchors the local economy and runs around the clock, Contra Costa College brings thousands of students and staff to its hillside campus, and the San Pablo Avenue and 23rd Street corridors are lined with clinics, markets, restaurants, and neighborhood retail that see constant foot traffic. Facilities here work hard — long hours, high volume, and floors that show it. KCS crews already run West County routes through Richmond, Pinole, and El Cerrito, so San Pablo businesses get the same nightly janitorial service, deep cleans, and floor care with fast response and no travel premium.",
    businessLandscape:
      "San Pablo's commercial mix centers on the casino and its hospitality operations, Contra Costa College's campus buildings, medical and dental clinics serving West County, and dense storefront retail along San Pablo Avenue and 23rd Street. Property managers here handle older buildings with heavy daily use — exactly the profile where consistent janitorial service and periodic floor restoration pay off most visibly.",
    districts: [
      "San Pablo Avenue corridor",
      "23rd Street commercial district",
      "El Portal Drive area",
      "Contra Costa College area",
    ],
    landmarks: ["San Pablo Lytton Casino", "Contra Costa College", "San Pablo City Hall"],
    clientTypes: ["offices", "medical facilities", "retail", "restaurants", "churches", "property managers"],
    nearby: ["richmond", "pinole", "el-cerrito", "hercules"],
    lat: 37.9622,
    lng: -122.3456,
  },
  {
    ...
    zip: "95620",
    intro:
      "Dixon sits on the I-80 corridor between Vacaville and Davis, and its commercial base punches above its size. Agricultural processors and light industrial operations cluster near the highway, the downtown First Street district keeps a working core of offices, banks, and storefronts, and community anchors like the Dixon May Fair grounds host events that fill the calendar. Distribution and ag-industrial facilities here need break rooms, offices, and restrooms maintained on schedules that respect production hours — which is exactly how KCS crews already work across Solano County. Nightly janitorial, deep cleans, and concrete floor care arrive in Dixon on the same routes that serve Vacaville and Fairfield.",
    businessLandscape:
      "Dixon's commercial property mix combines ag-industrial and food-processing facilities near I-80, distribution and light manufacturing space, a compact downtown of offices and retail along First Street and A Street, plus schools, churches, and medical offices serving a growing residential base. It's a market where dependable scheduled service matters more than flash — buildings run long hours and managers value crews that show up.",
    districts: [
      "Downtown First Street district",
      "I-80 / Currey Road industrial area",
      "North First Street corridor",
    ],
    landmarks: ["Dixon May Fair grounds", "Dixon City Hall", "Northwest Park"],
    clientTypes: ["warehouses", "offices", "retail", "churches", "medical facilities"],
    nearby: ["vacaville", "davis", "fairfield"],
    lat: 38.4455,
    lng: -121.8233,
  },
];
