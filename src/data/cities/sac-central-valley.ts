...
export const cities: City[] = [
  ...
  },
  {
    ...
    nearby: ["sacramento", "davis", "elk-grove", "vacaville", "woodland"],
    lat: 38.5805,
    lng: -121.5302,
  },
  {
    ...
    nearby: ["west-sacramento", "sacramento", "vacaville", "fairfield", "woodland"],
    lat: 38.5449,
    lng: -121.7405,
  },
  {
  ...
  },
  {
    ...
    nearby: ["manteca", "stockton", "livermore", "dublin", "lathrop"],
    lat: 37.7397,
    lng: -121.4252,
  },
  {
    ...
    nearby: ["stockton", "tracy", "modesto", "lodi", "lathrop"],
    lat: 37.7974,
    lng: -121.2161,
  },
  {
  ...
  },
  {
    ...
    zip: "95695",
    intro:
      "Woodland is Yolo County's working capital — the county seat, a historic downtown of offices and storefronts along Main Street, and one of the Sacramento region's densest concentrations of food processing and distribution. The I-5 corridor industrial parks house major warehouse operations, Dignity Health's Woodland Memorial Hospital anchors the medical sector, and the county courthouse and government complex keep a steady daytime professional population. Facilities like these need janitorial partners who can handle both an office suite and a 200,000-square-foot distribution floor. KCS serves Woodland alongside Davis and West Sacramento, bringing nightly janitorial, deep cleans, and the concrete floor care that warehouse operators actually notice.",
    businessLandscape:
      "Woodland's commercial stock spans large-footprint distribution and food-processing facilities along the I-5 and East Main corridors, county government and court buildings downtown, Woodland Memorial Hospital and its surrounding medical offices, plus a historic Main Street retail district. It's a market of long-lease industrial tenants and civic facilities — steady, schedule-driven accounts that reward reliable crews.",
    districts: [
      "Historic Main Street downtown",
      "I-5 / East Main industrial corridor",
      "County government district",
      "East Street commercial corridor",
    ],
    landmarks: ["Yolo County Courthouse", "Woodland Memorial Hospital", "Woodland Opera House"],
    clientTypes: ["warehouses", "offices", "medical facilities", "retail", "churches", "property managers"],
    nearby: ["davis", "west-sacramento", "sacramento"],
    lat: 38.6785,
    lng: -121.7733,
  },
  {
    ...
    zip: "95330",
    intro:
      "Lathrop has transformed from a crossroads town into one of Northern California's fastest-growing logistics hubs. Tesla's Megafactory anchors an industrial base that includes major distribution centers for national retailers, the Crossroads Commerce Center, and a steady pipeline of new tilt-up warehouse space at the I-5 and Highway 120 junction. Meanwhile the River Islands development is adding schools, retail, and commercial services at a pace few valley cities match. All of that new square footage needs maintenance from day one — post-construction cleanup, polished concrete care, and nightly janitorial for offices and break rooms. KCS crews already serve Tracy, Manteca, and Stockton, so Lathrop sits squarely on routes we run every night.",
    businessLandscape:
      "Lathrop's commercial profile is dominated by large-footprint distribution and manufacturing — Tesla's Megafactory and the warehouse parks around I-5 and Highway 120 — supported by growing retail, new schools in River Islands, and civic facilities. For facility managers the pattern is clear: big concrete floors, 24-hour operations, and office/break-room areas that need consistent overnight service.",
    districts: [
      "I-5 / Highway 120 logistics corridor",
      "Crossroads Commerce Center",
      "River Islands development",
      "Historic Lathrop / 7th Street area",
    ],
    landmarks: ["Tesla Megafactory Lathrop", "River Islands", "Lathrop Generations Center"],
    clientTypes: ["warehouses", "offices", "private schools", "retail", "property managers"],
    nearby: ["tracy", "manteca", "stockton"],
    lat: 37.8227,
    lng: -121.2767,
  },
];
